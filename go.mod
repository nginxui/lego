...
require (
	...
	github.com/libdns/alidns v0.0.0-00010101000000-000000000000
	github.com/libdns/cloudflare v0.0.0-00010101000000-000000000000
	github.com/libdns/huaweicloud v0.3.5
	github.com/libdns/libdns v1.0.0
	github.com/libdns/tencentcloud v0.0.0-00010101000000-000000000000

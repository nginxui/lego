...
const ChangeResourceRecordSetsResponseBody = `<?xml version="1.0" encoding="UTF-8"?>
...
const ListHostedZonesByNameResponseBody = `<?xml version="1.0" encoding="UTF-8"?>
...
const GetChangeResponseBody = `<?xml version="1.0" encoding="UTF-8"?>
